    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                //Form Open
                echo form_open(base_url('admin/type'));
                ?>

                <div class="form-group">
                    <label>Nama Type</label>
                    <input type="text" class="form-control" name="type_name" placeholder="Nama Type">
                    <?php echo form_error('type_name', '<small class="text-danger">', '</small>'); ?>
                </div>
